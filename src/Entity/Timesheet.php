 ...
 *          @ORM\Index(columns={"user","morning_start_time"}),
 *          @ORM\Index(columns={"morning_start_time"}),
 *          @ORM\Index(columns={"morning_start_time","aprem_end_time"}),
 *          @ORM\Index(columns={"morning_start_time","aprem_end_time","user"}),
 *     }
 * )
...
class Timesheet implements EntityWithMetaFields, ExportItemInterface
{
     ...
     * @Serializer\Accessor(getter="getMBegin")
     *
     * Attention: Accessor MUST be used, otherwise date will be serialized in UTC.
     *
     * @ORM\Column(name="aprem_start_time", type="datetime", nullable=true)
     */
    private $mBegin;
     ...
     * @Serializer\Groups({"Default"})
     * @Serializer\Type(name="DateTime")
     * @Serializer\Accessor(getter="getMEnd")
     *
     * Attention: Accessor MUST be used, otherwise date will be serialized in UTC.
     *
     * @ORM\Column(name="morning_end_time", type="datetime", nullable=true)
     */
    private $mEnd;
    /**
     * @var DateTime
     ...
     * Attention: Accessor MUST be used, otherwise date will be serialized in UTC.
     *
     * @ORM\Column(name="morning_start_time", type="datetime", nullable=true)
     * @Assert\NotNull()
     */
    private $begin;
    /**
     ...
     * Attention: Accessor MUST be used, otherwise date will be serialized in UTC.
     *
     * @ORM\Column(name="aprem_end_time", type="datetime", nullable=true)
     */
    private $end;

    /**
     * @var bool
     * @ORM\Column(name="halfday", type="boolean", nullable=true)
     */
     ...
     * @ORM\JoinColumn(onDelete="CASCADE", nullable=true)php
     */
    private $activity;
    /**
     * Project
    ...
    public function getMBegin(): ?DateTime
    {
        $this->localizeDates();
    ...
    /**
     * @param DateTime $mBegin
     * @return Timesheet
     */
    public function setMBegin(DateTime $mBegin): Timesheet
    {
        $this->mBegin = $mBegin;
        $this->timezone = $mBegin->getTimezone()->getName();

        return $this;
    }


    public function getMEnd(): ?DateTime
    {
        $this->localizeDates();
        return $this->mEnd;
     ...
     * @return Timesheet
     */
    public function setMEnd(DateTime $mEnd): Timesheet
    {
        $this->mEnd = $mEnd;
        $this->timezone = $mEnd->getTimezone()->getName();
     ...
     * @return Timesheet
     */
    public function setHalfday(bool $halfday): Timesheet
    {
